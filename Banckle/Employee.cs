...
namespace Banckle
{
	...
	/// 
	/// </summary>
	public class Employee : BanckleCRM
	{
		/// <summary>
		/// 
		/// </summary>
		...
		/// <param name="skypeId"></param>
		/// <param name="birthDay"></param>
		public Employee(string companyName, string firstName, string lastName, string title, string role, string description, string skypeId, string birthDay)
		{
